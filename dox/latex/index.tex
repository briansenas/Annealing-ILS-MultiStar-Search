...
\begin{DoxyItemize}
\item ./\+ILS (filename) (label1)\mbox{[}char\mbox{]} (label2)\mbox{[}char\mbox{]} (0=Print/1=Write\+File/2=Write+\+Plot\+\_\+data) (seed)\mbox{[}-\/∞,∞\mbox{]} (0=No/1=Shuffle/2=Balanced)
\begin{DoxyItemize}
...
\end{DoxyItemize}
\item Análogamente para los demás algoritmos.
